...
const HackerNews = () => {
  ...
  console.log(hits);
  return (
    <div className="bg-white mx-auto mt-5 mb-5 w-2/4 rounded-lg shadow-md">
      <div className="">
        <input
          type="text"
        ...
        <button
          ...
          className="bg-blue-500 text-white font-semibold p-3 px-48 rounded-md flex-shrink-0 my-6"
        >
          Fetching
        </button>
        {loading && (
