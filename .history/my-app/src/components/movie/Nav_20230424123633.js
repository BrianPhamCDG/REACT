...
const Nav = () => {
  return (
    <div className="nav-wrapper flex flex-row items-center w-full">
      ...
      <div className="nav-2 left-auto flex flex-row gap-5 cursor-pointer">
        <div className="nav-icon-search  rounded-full flex items-center justify-center">
          <BiBell className="text-2xl text-white"></BiBell>
        </div>
        <div className="nav-user flex flex-row gap-3 items-center">
          ...
          <div className="user-profile-wrap flex row-auto items-center">
            <div className="name text-base text-white">Mike</div>
            <BiCaretDown className="w-[32px] h-[32px] text-white" />
          </div>
        </div>
      </div>
    </div>
