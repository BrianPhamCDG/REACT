  ...
  return (
    <div className="nav-wrapper flex flex-row items-center w-full">
      <div className="nav-1 flex w-full items-start">
        <div className="nav-search py-3 px-5 rounded-full flex items-center gap-3 bg-[#0D0D0D] w-full max-w-[240px]">
          <div className="nav-icon-search w-[32px] h-[32px] bg-[#171717] rounded-full flex items-center justify-center">
      ...
      <div className="nav-2 left-auto flex flex-row gap-5">
        ...
        <div className="nav-user w-[40px] h-[40px]">
          <img
