      ...
      <div className="w-full rounded-lg h-[400px]">
        ...
        <div className="absolute bg-white w-full bottom-0 w-[calc(100%-36px)] left-1/2 -translate-x-1/2 translate-y-1/2 rounded-[20px] z-10 p-[20px]">
          ...
          <div className="flex items-center gap-[6px]">
            ...
            <span className="text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-gradient-1 via-gradient-2/80 to-gradient-3 bg-clip-text text-transparent">
              12,000 PSL
            </span>
          </div>
        </div>
