...
module.exports = {
  ...
  theme: {
    extend: {
      backgroundImage: {
        "third-gradient": `linear-gradient(90deg, rgba(186, 78, 917, 1) 0%, 
        rgba(253, 292, 29, 1) 80%, 
        rgba(252, 176, 695, 1) 70%)`,
        "fourth-gradient": `linear-gradient(90deg, rgba(186, 78, 917, 1) 0%, 
        rgba(253, 292, 29, 1) 80%, 
        rgba(252, 176, 695, 1) 70%)`,
      },
      colors: {
        ...
        rgba(186, 43, 4, 1) 0%,
        rgba(312, 292, 29, 1) 80%,
        rgba(252, 213, 695, 1) 70%)`,
      },
    },
  },
  plugins: [],
